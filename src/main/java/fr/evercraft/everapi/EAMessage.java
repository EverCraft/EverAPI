...
public class EAMessage extends EMessage<EverAPI> {
	...
	public enum EAMessages implements EnumMessage {
		...
		FLAG_MESSAGE_JOIN("flag.messageJoin",			
				"&7, "),
		FLAG_MESSAGE_CHAT("flag.messageChat",			
				"&cCHAT"),
		FLAG_MESSAGE_CHAT_MESSAGE("flag.messageChatMessage",			
				"&6Message : &c<message>"),
		FLAG_MESSAGE_CHAT_PREFIX("flag.messageChatPrefix",			
				"&6Prefix : &c<prefix>"),
		
		FLAG_MESSAGE_ACTIONBAR("flag.messageActionBar",			
				"&cACTION_BAR"),
		FLAG_MESSAGE_ACTIONBAR_MESSAGE("flag.messageActionBarMessage",			
				"&6Message : &c<message>"),
		FLAG_MESSAGE_ACTIONBAR_PREFIX("flag.messageActionBarPrefix",			
				"&6Prefix : &c<prefix>"),
		FLAG_MESSAGE_ACTIONBAR_STAY("flag.messageActionBarStay",			
				"&6Stay : &c<stay>(ms)"),
		FLAG_MESSAGE_ACTIONBAR_PRIORITY("flag.messageActionBarPriority",			
				"&6Priority : &c<priority>"),
		
		FLAG_MESSAGE_TITLE("flag.messageTitle",			
				"&cTITLE"),
		FLAG_MESSAGE_TITLE_MESSAGE("flag.messageTitleMessage",			
				"&6Message : &c<message>"),
		FLAG_MESSAGE_TITLE_SUBMESSAGE("flag.messageTitleSubMessage",			
				"&6Prefix : &c<prefix>"),
		FLAG_MESSAGE_TITLE_PREFIX("flag.messageTitlePrefix",			
				"&6SubMessage : &c<submessage>"),
		FLAG_MESSAGE_TITLE_SUBPREFIX("flag.messageTitleSubPrefix",			
				"&6SubPrefix : &c<subprefix>"),
		FLAG_MESSAGE_TITLE_STAY("flag.messageTitleStay",			
				"&6Stay : &c<stay>(ms)"),
		FLAG_MESSAGE_TITLE_FADEIN("flag.messageTitleFadeIn",			
				"&6FadeIn : &c<fadein>(ms)"),
		FLAG_MESSAGE_TITLE_FADEOUT("flag.messageTitleFadeOut",			
				"&6FadeOut : &c<fadeout>(ms)"),
		FLAG_MESSAGE_TITLE_PRIORITY("flag.messageTitlePriority",			
				"&6Priority : &c<priority>"),
		
		FLAG_MESSAGE_BOSSBAR("flag.messageBossBar",			
				"&cBOSSBAR"),
		FLAG_MESSAGE_BOSSBAR_MESSAGE("flag.messageBossBarMessage",			
				"&6Message : &c<message>"),
		FLAG_MESSAGE_BOSSBAR_PREFIX("flag.messageBossBarPrefix",			
				"&6Prefix : &c<prefix>"),
		FLAG_MESSAGE_BOSSBAR_STAY("flag.messageBossBarStay",			
				"&6Stay : &c<stay>(ms)"),
		FLAG_MESSAGE_BOSSBAR_CREATEFOG("flag.messageBossBarCreateFog",			
				"&6CreateFog : &c<createfog>"),
		FLAG_MESSAGE_BOSSBAR_DARKENSKY("flag.messageBossBarDarkenSky",			
				"&6DarkenSky : &c<darkensky>"),
		FLAG_MESSAGE_BOSSBAR_MUSIC("flag.messageBossBarMusic",			
				"&6Music : &c<music>"),
		FLAG_MESSAGE_BOSSBAR_COLOR("flag.messageBossBarColor",			
				"&6Color : &c<color>"),
		FLAG_MESSAGE_BOSSBAR_OVERLAY("flag.messageBossBarOverlay",			
				"&6Overlay : &c<overlay>"),
		FLAG_MESSAGE_BOSSBAR_PERCENT("flag.messageBossBarPercent",			
				"&6Percent : &c<percent>"),
		FLAG_MESSAGE_BOSSBAR_PRIORITY("flag.messageBossBarPriority",			
				"&6Priority : &c<priority>"),
		
		FLAG_CATALOG_TYPE_JOIN("flag.catalogTypeJoin",			
				"&7, "),
		FLAG_CATALOG_TYPE_GROUP("flag.catalogTypeGroup",			
				"&c<group>"),
		FLAG_CATALOG_TYPE_EMPTY("flag.catalogTypeEmpty",			
				"&cAucun"),
		FLAG_CATALOG_TYPE_HOVER("flag.catalogTypeHover",			
				"&c<type>"),
		FLAG_CATALOG_TYPE_MORE("flag.catalogTypeMore",			
				"&c..."),
		
		FLAG_ENTITYTEMPLATE_JOIN("flag.entityTemplateJoin",			
				"&7, "),
		FLAG_ENTITYTEMPLATE_GROUP("flag.entityTemplateGroup",			
				"&c<group>"),
		FLAG_ENTITYTEMPLATE_EMPTY("flag.entityTemplateEmpty",			
				"&cAucun"),
