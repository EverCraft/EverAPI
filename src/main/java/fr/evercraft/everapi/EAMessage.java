...
public class EAMessage extends EMessage<EverAPI> {
	...
	public enum EAMessages implements EnumMessage {
		...
		FLAG_BLOCKTYPE_JOIN("flag.blockTypeJoin",			
				"&7, "),
		FLAG_BLOCKTYPE_GROUP("flag.blockTypeGroup",			
				"&c<group>"),
		FLAG_BLOCKTYPE_EMPTY("flag.blockTypeEmpty",			
				"&cAucun"),
		FLAG_BLOCKTYPE_HOVER("flag.blockTypeHover",			
				"&c<block>"),
