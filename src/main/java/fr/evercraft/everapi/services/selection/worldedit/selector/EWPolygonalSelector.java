...
public class EWPolygonalSelector extends EWSelector implements Selector.Polygonal {
	
	public EWPolygonalSelector(SpongeWorldEdit worldedit, Player player, LocalSession session, Polygonal2DRegionSelector selector) {
