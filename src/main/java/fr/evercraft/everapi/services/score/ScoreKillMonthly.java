...
public class ScoreKillMonthly extends ScoreType {

	public ScoreKillMonthly(String name, EverAPI plugin) {
		super(name, plugin);
	}
    ...
    public void event(StatsUserEvent.Kill event) {
		this.update(event.getKiller().getUniqueId(), ScoreTypes.KILLS);
	}
