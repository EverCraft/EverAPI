...
public abstract class BanEvent extends AbstractEvent {
	...
	private final SanctionBanProfile sanction;
	private final Cause cause;
	
	
	public BanEvent(EUser user, Optional<EPlayer> player, Text reason, long creationDate, 
			Optional<Long> expirationDate, String source, SanctionBanProfile sanction, Cause cause) {
		super();
		this.user = user;
		this.player = player;
		this.reason = reason;
	...
	public SanctionBanProfile getSanction() {
	...
	public static class Enable extends BanEvent implements Cancellable {
		private final CommandSource commandSource;
		private boolean cancelled;
		
		public Enable(EUser user, Optional<EPlayer> player, Text reason, long creationDate, 
				Optional<Long> expirationDate, SanctionBanProfile sanction, CommandSource commandSource, Cause cause) {
	...
	public static class Disable extends BanEvent {
		...
		public Disable(EUser user, Optional<EPlayer> player, Text reason, long creationDate, 
				Optional<Long> expirationDate, SanctionBanProfile sanction, String source, 
